      ...
      <Carousel opts={{ align: 'start' }} className='w-full'>
        <div className='md:px-4 relative'>
          ...
          <div className='text-left mb-12 space-y-4'>
            <motion.div initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className='inline-flex items-center gap-2'>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.5 }} className='flex justify-between items-center md:relative'>
              <h2 className='text-2xl md:text-3xl lg:text-5xl font-bold max-w-lg lg:max-w-4xl'>{`Here's a streamlined work process for your projects:`}</h2>
