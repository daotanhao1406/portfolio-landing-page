...
export default function RowCard(props: ColumnCardProps) {
  return (
    <div className='w-full lg:h-96 h-80 flex items-center p-8 bg-[#F1DEBB] rounded-lg bg-information-card bg-cover bg-no-repeat bg-top'>
      <div className='w-1/2 text-left flex flex-col justify-center pr-4 space-y-2'>
        ...
        <p className='text-gray-600 text-xs md:text-sm pt-2 pr-4'>{props.description}</p>
      </div>
