    ...
    <section className="lg:pt-16 md:pt-8 pt-2 px-4 md:px-8 pb-20">
      <div className="max-w-7xl mx-auto">
        <div   className="text-center max-w-4xl mx-auto lg:space-y-12">
          ...
          transition={{ duration: 1.5 }} className="flex flex-col items-center text-3xl md:text-5xl lg:text-7xl font-bold mb-6 font-polysans">
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }} className="flex gap-4 justify-center">
